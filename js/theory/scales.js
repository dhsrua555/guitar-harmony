...
(function () {
  ...
  const SCALES = [
    /* --- 메이저 스케일의 모드 --- */
    { id: 'ionian', ko: '아이오니안 (메이저 스케일)', en: 'Ionian / Major', intervals: ['1', '2', '3', '4', '5', '6', '7'], category: 'major', parent: 'ionian', modeIndex: 1, characteristic: ['4', '7'], avoid: ['4'], chords: ['maj', 'maj7', '6', '69', 'maj9', 'add9', 'sus2'], desc: '장음계이자 기능화성의 기준이 되는 스케일. maj7 위의 4음은 장3도와 단9도 마찰을 만들 수 있어 지속음이나 강박에서 주의한다.', usage: '메이저 키의 I 코드, 팝, 클래식, 동요' },
    { id: 'dorian', ko: '도리안', en: 'Dorian', intervals: ['1', '2', 'b3', '4', '5', '6', 'b7'], category: 'major', parent: 'ionian', modeIndex: 2, characteristic: ['6'], avoid: [], chords: ['min', 'm7', 'm6', 'm9', 'm11', 'm69'], desc: '마이너 계열이지만 장6도가 있어 밝은 색이 섞인 모드. m7 위에서 자주 선택하는 대표적인 출발점이다.', usage: 'ii-V-I의 ii, 모달 재즈(So What), 펑크, 산타나 스타일' },
    ...
    { id: 'aeolian', ko: '에올리안 (자연 단음계)', en: 'Aeolian / Natural Minor', intervals: ['1', '2', 'b3', '4', '5', 'b6', 'b7'], category: 'major', parent: 'ionian', modeIndex: 6, characteristic: ['b6'], avoid: ['b6'], chords: ['min', 'm7', 'm9', 'madd9'], desc: '가장 기본적인 단음계. 슬프고 서정적이며 록과 팝의 마이너 키에서 기본으로 쓴다.', usage: '마이너 키의 i 코드, 록 발라드, 팝' },
    { id: 'locrian', ko: '로크리안', en: 'Locrian', intervals: ['1', 'b2', 'b3', '4', 'b5', 'b6', 'b7'], category: 'major', parent: 'ionian', modeIndex: 7, characteristic: ['b5'], avoid: ['b2'], chords: ['dim', 'm7b5'], desc: 'b2와 b5가 있는 어두운 모드. 완전5도 대신 감5도가 있어 토닉 중심을 안정시키기 어렵고 m7b5 코드 위에서 자주 쓴다.', usage: '마이너 ii-V의 iiø7 위, 메탈' },
    /* --- 마이너 스케일 --- */
    { id: 'harmonic_minor', ko: '하모닉 마이너', en: 'Harmonic Minor', intervals: ['1', '2', 'b3', '4', '5', 'b6', '7'], category: 'minor', parent: 'harmonic_minor', modeIndex: 1, characteristic: ['7', 'b6'], avoid: [], chords: ['min', 'mMaj7', 'madd9'], desc: '자연 단음계의 7음을 올려 리딩톤을 만든 스케일. b6과 7 사이의 증2도가 이국적인 긴장을 만든다.', usage: '마이너 키의 V7 → i 해결, 네오클래시컬 메탈, 클래식' },
    ...
    /* --- 펜타토닉, 블루스 --- */
    { id: 'major_pent', ko: '메이저 펜타토닉', en: 'Major Pentatonic', intervals: ['1', '2', '3', '5', '6'], category: 'pentatonic', parent: 'major_pent', modeIndex: 1, characteristic: [], avoid: [], chords: ['maj', '6', '69', 'add9', 'maj7', '7'], desc: '메이저 스케일에서 4음과 7음을 뺀 5음 음계. 메이저 코드의 주요 코드톤과 9, 13을 담아 선율과 즉흥연주의 출발점으로 쓰기 좋다.', usage: '컨트리, 남부 록, 블루스 (메이저 느낌), 팝' },
    { id: 'minor_pent', ko: '마이너 펜타토닉', en: 'Minor Pentatonic', intervals: ['1', 'b3', '4', '5', 'b7'], category: 'pentatonic', parent: 'major_pent', modeIndex: 5, characteristic: [], avoid: [], chords: ['min', 'm7', 'm11', '7', '5'], desc: '자연 단음계에서 2음과 b6을 뺀 5음 음계. 기타 솔로의 출발점이며 마이너 코드는 물론 블루스에서는 도미넌트 위에서도 쓴다.', usage: '블루스, 록, 거의 모든 기타 솔로' },
    ...
    { id: 'augmented', ko: '어그멘티드 스케일', en: 'Augmented Scale', intervals: ['1', '#2', '3', '5', '#5', '7'], category: 'symmetric', parent: 'augmented', modeIndex: 1, characteristic: ['#5'], avoid: [], chords: ['aug', 'augMaj7', 'maj7'], desc: '단3도와 반음이 번갈아 나오는 6음 대칭 스케일. 두 개의 어그멘티드 3화음을 겹친 형태.', usage: 'augMaj7, 현대 재즈 (마이클 브레커, 올리버 넬슨)' },
    /* --- 비밥 --- */
    { id: 'bebop_dom', ko: '비밥 도미넌트', en: 'Bebop Dominant', intervals: ['1', '2', '3', '4', '5', '6', 'b7', '7'], category: 'bebop', parent: 'bebop_dom', modeIndex: 1, characteristic: ['7'], avoid: [], chords: ['7', '9', '13'], desc: '믹솔리디안에 장7도를 경과음으로 더한 8음 스케일. 코드톤에서 시작해 연속 8분음표로 연주하면 다음 코드톤을 강박에 배치하기 쉽다.', usage: 'V7 코드 위 비밥 라인' },
    ...
    { id: 'bebop_dorian', ko: '비밥 도리안', en: 'Bebop Dorian', intervals: ['1', '2', 'b3', '3', '4', '5', '6', 'b7'], category: 'bebop', parent: 'bebop_dorian', modeIndex: 1, characteristic: ['3'], avoid: [], chords: ['m7', 'm9'], desc: '도리안에 장3도를 경과음으로 더한 스케일. ii7 코드 위 비밥 라인에 쓴다.', usage: 'ii7 코드 위' },
    /* --- 기타 --- */
    ...
    { id: 'hungarian_minor', ko: '헝가리안 마이너', en: 'Hungarian Minor', intervals: ['1', '2', 'b3', '#4', '5', 'b6', '7'], category: 'exotic', parent: 'hungarian_minor', modeIndex: 1, characteristic: ['#4', '7'], avoid: [], chords: ['min', 'mMaj7'], desc: '하모닉 마이너에 #4를 더한 스케일. 증2도가 두 번 나와 집시 음악의 강렬한 색채를 낸다.', usage: '집시, 클레즈머, 네오클래시컬' },
    ...
    { id: 'hirajoshi', ko: '히라조시 (平調子)', en: 'Hirajoshi', intervals: ['1', '2', 'b3', '5', 'b6'], category: 'exotic', parent: 'hirajoshi', modeIndex: 1, characteristic: ['b6'], avoid: [], chords: ['min', 'madd9'], desc: '일본 고토 음계 중 하나. 5음 음계이지만 반음이 있어 펜타토닉과 다른 긴장이 있다.', usage: '일본풍, 마티 프리드먼 스타일' },
    { id: 'in_sen', ko: '인센 (陰旋)', en: 'In Sen', intervals: ['1', 'b2', '4', '5', 'b7'], category: 'exotic', parent: 'in_sen', modeIndex: 1, characteristic: ['b2'], avoid: [], chords: ['sus4', '7sus4'], desc: '일본 음계. b2와 4가 있어 sus4 b9 코드 위에서 쓸 수 있다.', usage: '일본풍, 7sus4(b9) 코드' },
    { id: 'yo', ko: '요 (陽旋, 민요 음계)', en: 'Yo Scale', intervals: ['1', '2', '4', '5', '6'], category: 'exotic', parent: 'major_pent', modeIndex: 4, characteristic: [], avoid: [], chords: ['sus2', 'sus4', 'maj'], desc: '3음이 없는 일본 민요 음계. 메이저 펜타토닉의 모드이며 밝고 담백하다.', usage: '민요풍, 국악 계열 멜로디' }
  ];
