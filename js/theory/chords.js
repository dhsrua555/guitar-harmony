...
(function () {
  ...
  const QUALITIES = [
    { id: 'maj', sym: '', jazz: '', aliases: ['M', 'maj', 'major', '△'], ko: '메이저', intervals: ['1', '3', '5'], family: 'major', tensions: ['9', '13', '#11'], avoid: ['4'], scales: ['ionian', 'lydian', 'major_pent', 'mixolydian'], desc: '장3도 위에 단3도를 쌓은 밝고 안정적인 기본 3화음. 조성의 중심이 되는 소리.' },
    { id: 'min', sym: 'm', jazz: '-', aliases: ['m', 'min', '-', 'minor'], ko: '마이너', intervals: ['1', 'b3', '5'], family: 'minor', tensions: ['9', '11'], avoid: ['b6'], scales: ['aeolian', 'dorian', 'minor_pent', 'phrygian'], desc: '단3도 위에 장3도를 쌓은 어둡고 차분한 3화음. 메이저의 3음을 반음 내린 형태.' },
    { id: 'dim', sym: 'dim', jazz: '°', aliases: ['dim', '°', 'o'], ko: '디미니시드', intervals: ['1', 'b3', 'b5'], family: 'diminished', tensions: [], avoid: [], scales: ['locrian', 'wh_dim'], desc: '단3도를 두 번 쌓아 감5도가 생기는 불안정한 3화음. 다이어토닉에서는 vii°로 도미넌트 기능을 한다.' },
    { id: 'aug', sym: 'aug', jazz: '+', aliases: ['aug', '+', '#5'], ko: '어그멘티드', intervals: ['1', '3', '#5'], family: 'augmented', tensions: ['9'], avoid: [], scales: ['whole_tone', 'lydian_aug', 'augmented'], desc: '장3도를 두 번 쌓은 대칭 3화음. 4반음마다 같은 모양이 반복되어 세 개의 루트를 가진다.' },
    ...
    { id: '6', sym: '6', jazz: '6', aliases: ['6', 'maj6', 'M6'], ko: '메이저 6', intervals: ['1', '3', '5', '6'], family: 'major', tensions: ['9'], avoid: ['4'], scales: ['ionian', 'lydian', 'major_pent'], desc: '메이저 3화음에 장6도를 더한 코드. maj7보다 부드럽게 곡을 끝낼 때 쓴다. 같은 음의 m7 (예: C6 = Am7)과 구성음이 같다.' },
    { id: 'm6', sym: 'm6', jazz: '-6', aliases: ['m6', 'min6', '-6'], ko: '마이너 6', intervals: ['1', 'b3', '5', '6'], family: 'minor', tensions: ['9'], avoid: [], scales: ['dorian', 'melodic_minor'], desc: '마이너 3화음에 장6도를 더한 코드. 도리안이나 멜로딕 마이너의 소리이며 m7b5 (예: Cm6 = Am7b5)와 구성음이 같다.' },
    { id: 'maj7', sym: 'maj7', jazz: '△7', aliases: ['maj7', 'M7', 'Maj7', '△7', 'Δ7', 'ma7', 'j7'], ko: '메이저 7', intervals: ['1', '3', '5', '7'], family: 'major', tensions: ['9', '13', '#11'], avoid: ['4'], scales: ['ionian', 'lydian', 'major_pent', 'bebop_major'], desc: '메이저 3화음에 장7도를 더한 코드. 부드럽고 세련된 토닉 소리. 재즈, 보사노바, 네오소울의 기본.' },
    { id: '7', sym: '7', jazz: '7', aliases: ['7', 'dom7'], ko: '도미넌트 7', intervals: ['1', '3', '5', 'b7'], family: 'dominant', tensions: ['9', '13', 'b9', '#9', '#11', 'b13'], avoid: ['4'], scales: ['mixolydian', 'lydian_dom', 'altered', 'hw_dim', 'whole_tone', 'bebop_dom', 'blues', 'phrygian_dom'], desc: '메이저 3화음에 단7도를 더한 코드. 3음과 b7음이 만드는 트라이톤이 해결을 요구하는 도미넌트 기능의 핵심. 블루스에서는 토닉으로도 쓴다.' },
    { id: 'm7', sym: 'm7', jazz: '-7', aliases: ['m7', 'min7', '-7'], ko: '마이너 7', intervals: ['1', 'b3', '5', 'b7'], family: 'minor', tensions: ['9', '11'], avoid: ['b6'], scales: ['dorian', 'aeolian', 'phrygian', 'minor_pent', 'bebop_dorian'], desc: '마이너 3화음에 단7도를 더한 코드. ii-V-I의 ii, 마이너 키의 토닉 등으로 자주 쓰이는 마이너 7화음.' },
    { id: 'm7b5', sym: 'm7b5', jazz: 'ø7', aliases: ['m7b5', 'ø7', 'ø', 'm7(b5)', '-7b5', 'min7b5', 'half-dim'], ko: '마이너 7 b5 (하프 디미니시드)', intervals: ['1', 'b3', 'b5', 'b7'], family: 'diminished', tensions: ['9', '11', 'b13'], avoid: ['b2'], scales: ['locrian', 'locrian_nat2', 'locrian_nat6'], desc: '디미니시드 3화음에 단7도를 더한 코드. 마이너 ii-V-i의 ii, 메이저 키의 vii로 쓰인다.' },
    { id: 'dim7', sym: 'dim7', jazz: '°7', aliases: ['dim7', '°7', 'o7'], ko: '디미니시드 7', intervals: ['1', 'b3', 'b5', 'bb7'], family: 'diminished', tensions: ['9', '11', 'b13', '7'], avoid: [], scales: ['wh_dim'], desc: '단3도만으로 쌓은 완전 대칭 코드. 3반음마다 같은 모양이 반복되어 네 개의 루트를 가진다. 패싱 코드와 7b9의 대체로 쓴다.' },
    { id: 'mMaj7', sym: 'mMaj7', jazz: '-△7', aliases: ['mMaj7', 'mM7', 'm(maj7)', 'minmaj7', '-maj7', '-△7', 'mΔ7'], ko: '마이너 메이저 7', intervals: ['1', 'b3', '5', '7'], family: 'minor', tensions: ['9', '11', '13'], avoid: [], scales: ['melodic_minor', 'harmonic_minor'], desc: '마이너 3화음에 장7도를 더한 코드. 멜로딕/하모닉 마이너의 토닉. 긴장감 있는 영화음악적 소리.' },
    { id: 'augMaj7', sym: 'maj7#5', jazz: '△7#5', aliases: ['maj7#5', 'augmaj7', '+maj7', 'M7#5', 'maj7+5', '△7#5'], ko: '메이저 7 #5', intervals: ['1', '3', '#5', '7'], family: 'augmented', tensions: ['9', '#11'], avoid: [], scales: ['lydian_aug', 'ionian_aug'], desc: '어그멘티드 3화음에 장7도를 더한 코드. 멜로딕 마이너 3번째 모드(리디안 어그멘티드)의 소리.' },
    ...
    { id: 'madd9', sym: 'm(add9)', jazz: '-add9', aliases: ['madd9', 'm(add9)', 'madd2', '-add9'], ko: '마이너 애드 9', intervals: ['1', 'b3', '5', '9'], family: 'minor', tensions: [], avoid: [], scales: ['aeolian', 'dorian'], desc: '마이너 3화음에 9음을 더한 코드. 서정적이고 영화적인 소리.' },
    ...
    { id: '7#9', sym: '7#9', jazz: '7#9', aliases: ['7#9', '7(#9)', '7+9'], ko: '도미넌트 7 #9', intervals: ['1', '3', '5', 'b7', '#9'], family: 'dominant', tensions: ['b13', 'b9'], avoid: [], scales: ['altered', 'blues', 'hw_dim'], desc: '장3도와 증9도(단3도)가 함께 울리는 코드. 지미 헨드릭스 코드로 불리며 블루스, 펑크, 록에서 쓴다.' },
    ...
    { id: 'm69', sym: 'm6/9', jazz: '-6/9', aliases: ['m6/9', 'm69', 'm6add9'], ko: '마이너 식스 나인', intervals: ['1', 'b3', '5', '6', '9'], family: 'minor', tensions: [], avoid: [], scales: ['dorian', 'melodic_minor'], desc: 'm6에 9음을 더한 코드. 도리안의 특징음(장6도)과 9음이 함께 울리는 세련된 마이너.' },
    ...
    { id: 'add4', sym: 'add4', jazz: 'add4', aliases: ['add4', 'add11', '(add4)'], ko: '애드 4', intervals: ['1', '3', '4', '5'], family: 'major', tensions: [], avoid: [], scales: ['ionian', 'mixolydian'], desc: '메이저 3화음에 4음을 더한 코드. 3음과 4음이 붙어 있어 긴장감 있는 팝/록 사운드.' },
    { id: 'mb6', sym: 'm(b6)', jazz: '-b6', aliases: ['mb6', 'm(b6)', '-b6', 'mb13'], ko: '마이너 b6', intervals: ['1', 'b3', '5', 'b6'], family: 'minor', tensions: ['9'], avoid: [], scales: ['aeolian', 'harmonic_minor'], desc: '마이너 3화음에 단6도를 더한 코드. 에올리안과 하모닉 마이너의 어두운 색채로 영화음악에서 자주 쓴다.' },
    ...
    { id: 'dimMaj7', sym: 'dimMaj7', jazz: '°△7', aliases: ['dimMaj7', 'dimmaj7', '°maj7', 'dim(maj7)', '°△7', 'dimM7'], ko: '디미니시드 메이저 7', intervals: ['1', 'b3', 'b5', '7'], family: 'diminished', tensions: ['9', '11'], avoid: [], scales: ['wh_dim'], desc: '디미니시드 3화음에 장7도를 더한 코드. 온음-반음 디미니시드 스케일의 7음이며 dim7 대신 긴장을 더할 때 쓴다.' },
    ...
    { id: 'm13', sym: 'm13', jazz: '-13', aliases: ['m13', 'min13', '-13'], ko: '마이너 13', intervals: ['1', 'b3', '5', 'b7', '9', '13'], family: 'minor', tensions: ['11'], avoid: [], scales: ['dorian'], desc: 'm7에 9음과 13음을 더한 코드. 장6도(13)가 있어 도리안의 소리. 네오소울과 재즈 컴핑.' },
  ...
  const CATEGORY_KO = { triad: '기본 3화음 · 파워 코드', sus: 'sus 코드', add: '6th · add 코드', seventh: '7th 코드 (7화음)', ninth: '9th 코드', extended: '11th · 13th 코드', altered: '변화 도미넌트' };
  const CATEGORY_ORDER = ['triad', 'sus', 'add', 'seventh', 'ninth', 'extended', 'altered'];
  const CATEGORY_DESC = { triad: '메이저·마이너·디미니시드·어그멘티드 3화음과 두 음으로 된 파워 코드.', sus: '3음을 2음이나 4음으로 바꾼 코드. 메이저와 마이너가 확정되지 않은 열린 소리.', add: '7음 없이 6음, 9음, 4음 등을 더한 코드. 팝, 어쿠스틱, 발라드에서 자주 쓴다.', seventh: '3화음에 7음을 더한 코드. 재즈와 블루스 화성의 기본 단위.', ninth: '7화음 위에 9음을 더한 코드. 기본 7화음보다 넓고 풍부한 색을 낸다.', extended: '11음, 13음, #11까지 확장한 코드. 기타에서는 보통 근음이나 5음을 생략한다.', altered: 'b9, #9, b13처럼 변화 텐션을 포함한 도미넌트 코드.' };
  ...
  const LEVEL_OF = { maj: 1, min: 1, 5: 1, sus2: 1, sus4: 1, 7: 1, m7: 1, maj7: 1, add9: 1, dim: 1, 6: 2, m6: 2, m7b5: 2, dim7: 2, 9: 2, m9: 2, maj9: 2, '7sus4': 2, madd9: 2, 69: 2, mMaj7: 2, aug: 2, '7b9': 2, '7#9': 2, 13: 2, m11: 2, add4: 2, '7sus2': 2 };
  const LEVEL_KO = { 1: '기초', 2: '중급', 3: '고급' };
  QUALITIES.forEach(q => { q.category = CATEGORY_OF[q.id] || 'seventh'; q.level = LEVEL_OF[q.id] || 3; });
