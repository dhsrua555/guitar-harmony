...
(function () {
  ...
  const SECTIONS = [
    ...
    { id: 'drums', label: '드럼', en: 'DRUMS', icon: 'drum', color: 'pink', path: '/drums', desc: '스네어 하나로 하는 루디먼트부터 찹 · 그루브 · 필인 · 손발 조합까지, 드럼 보표와 킷 그림으로 연습합니다.', items: [
      ...
      ['/drums/chops', '찹 · 컴비네이션', 3, '버스트 · 식스 스트로크 · 3 대 4 액센트 · R L K 손발 조합'],
