...
(function () {
  ...
  GH.data.strums = [
    ...
    { id: 'pop', ko: '팝 기본 (D - D U - U D U)', grid: 8, p: 'D - D U - U D U', tempo: 90, desc: '가장 많이 쓰는 어쿠스틱 팝 패턴. 3박 앞의 비어 있는 다운이 당김음을 만듭니다. 손은 멈추지 말고 허공을 지나가세요.' },
    ...
    { id: 'bossa', ko: '보사노바 느낌 (D - U - D U - U)', grid: 8, p: 'D - U - D U - U', tempo: 100, desc: '베이스는 1·3박, 위쪽 줄은 당김음으로. 부드럽게 쓸듯이.' }
  ];
})();
