...
(function () {
  ...
  GH.data.modes = {
    lydian: { brightness: 7, color: '#f5b400', mood: '매우 밝고 떠 있는, 꿈꾸는 듯한', chord: 'maj7#11, maj9(#11), 6/9', vamp: ['Imaj7', 'II'], vampText: 'I△7 – II (예: F△7 – G)', songs: ['The Simpsons 테마 (리디안 도미넌트 섞임)', 'Joe Satriani – Flying in a Blue Dream', 'Fleetwood Mac – Dreams', '영화음악(존 윌리엄스, E.T. 비행 장면)'], tip: '♯4를 특징음으로 들려주면 리디안의 색채가 분명해진다. 완전4도를 강조하면 아이오니안 느낌이 커질 수 있다.' },
    ionian: { brightness: 6, color: '#f08c00', mood: '밝고 안정적, 익숙한', chord: 'maj7, 6, maj9, add9', vamp: ['Imaj7', 'IVmaj7'], vampText: 'I△7 – IV△7 (예: C△7 – F△7)', songs: ['Let It Be', '동요와 팝의 대부분', 'Beethoven – Ode to Joy'], tip: 'maj7 코드에서 4도를 길게 유지하거나 강박에 둘 때는 3음과의 단9도 충돌을 확인한다. 경과음이나 sus 소리로는 사용할 수 있다.' },
    ...
    dorian: { brightness: 4, color: '#22a06b', mood: '마이너지만 밝은, 쿨한, 펑키한', chord: 'm7, m6, m9, m11, m13', vamp: ['i7', 'IV7'], vampText: 'i7 – IV7 (예: Dm7 – G7)', songs: ['Miles Davis – So What', 'Santana – Oye Como Va', 'Daft Punk – Get Lucky', 'Scarborough Fair', 'Pink Floyd – Another Brick in the Wall Pt.2 (솔로)'], tip: '장6도가 특징음. 마이너 펜타토닉에 2음과 6음을 더하면 도리안이 된다. m7 컴핑이나 모달 뱀프에서 대표적인 출발점이다.' },
    aeolian: { brightness: 3, color: '#2f6fed', mood: '슬픈, 서정적, 록 발라드', chord: 'm7, m9, m(add9), m7(b6)', vamp: ['i', 'bVI', 'bVII'], vampText: 'i – bVI – bVII (예: Am – F – G)', songs: ['R.E.M. – Losing My Religion', 'Bob Dylan / Jimi Hendrix – All Along the Watchtower', 'The Cranberries – Zombie', 'Led Zeppelin – Stairway to Heaven (솔로)'], tip: 'b6이 특징음. 자연 단음계이며, V7이 필요하면 7음을 올려 하모닉 마이너로 잠시 바꾼다.' },
    phrygian: { brightness: 2, color: '#8b5cf6', mood: '어둡고 이국적, 스페인, 긴장', chord: 'm7, sus4(b9), m(b9)', vamp: ['i', 'bIImaj7'], vampText: 'i – bII△7 (예: Em – F△7)', songs: ['Jefferson Airplane – White Rabbit (인트로)', 'Metallica – Wherever I May Roam', '플라멩코 전반', 'Pink Floyd – Set the Controls for the Heart of the Sun'], tip: 'b2가 특징음. 3음을 장3도로 바꾸면 프리지안 도미넌트(플라멩코 소리)가 된다.' },
    locrian: { brightness: 1, color: '#374151', mood: '매우 어두운, 불안정한, 긴장된', chord: 'm7b5, dim', vamp: ['iø7', 'bIImaj7'], vampText: 'iø7 – bII△7 (예: Bø7 – C△7)', songs: ['Björk – Army of Me', 'Rush – YYZ (인트로 리프)', 'Metallica – Enter Sandman (리프의 b5)'], tip: '완전5도 대신 ♭5가 있어 토닉 코드의 안정감이 약하다. 실전에서는 iiø7 코드 위의 스케일 후보로 자주 쓴다.' },
    /* 멜로딕 마이너 모드 */
    ...
    /* 하모닉 마이너 모드 */
    harmonic_minor: { color: '#d946ef', mood: '클래식한 마이너, 이국적, 네오클래시컬', chord: 'mMaj7, m, m(add9)', vamp: ['i', 'V7'], vampText: 'i – V7 (예: Am – E7)', songs: ['Bach – Toccata and Fugue', 'Yngwie Malmsteen – Far Beyond the Sun', '집시 재즈, 클래식 마이너 키'], tip: 'b6과 7 사이의 증2도가 특징. V7 코드 위에서 쓰면 마이너 키 해결이 자연스럽다.' },
    ...
    phrygian_dom: { color: '#d946ef', mood: '플라멩코, 중동, 메탈', chord: '7b9, 7b9b13, 7(b13)', vamp: ['I7', 'bII'], vampText: 'I7 – bII (예: E7 – F)', songs: ['Hava Nagila', '플라멩코 (Andalusian cadence의 V)', 'Dick Dale – Misirlou (일부)', 'Yngwie Malmsteen 전반'], tip: '마이너 키의 V7 위에서 하모닉 마이너를 5도부터 시작한 것. b9와 3의 증2도가 특징.' },
