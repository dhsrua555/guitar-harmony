...
(function () {
  ...
  function build() {
    ...
    add('페이지', '음정 (Interval)', '화성학', ['interval', '인터벌', '음정', '도수'], '#/theory/intervals');
    ...
    add('페이지', '이어 트레이닝', '연습', ['ear training', '청음', '음감', '인터벌 퀴즈', '계이름', '근음', '퀴즈'], '#/ear');
    add('퀴즈', '계이름 맞추기 (메이저 스케일)', '이어 트레이닝', ['solfege', '음감', '도레미', '상대음감'], '#/ear?tab=degree');
    add('퀴즈', '음정 맞추기', '이어 트레이닝', ['interval', '인터벌', '청음'], '#/ear?tab=interval');
    add('퀴즈', '코드 진행 듣고 근음 계이름 맞추기', '이어 트레이닝', ['root', '루트', '근음', '진행', '베이스'], '#/ear?tab=root');
