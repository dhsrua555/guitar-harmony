/**
 * 밴드 & 화성학 · 버그 제보용 구글 폼 만들기 (Google Apps Script)
 *
 ...
 *
 * 만들어지는 것: 구글 폼 '밴드 & 화성학 버그 제보' + 응답이 쌓이는 스프레드시트.
...
function createBugForm() {
  var form = FormApp.create('밴드 & 화성학 버그 제보');
  ...
  var sheet = SpreadsheetApp.create('밴드 & 화성학 버그 제보 (응답)');
